...
do
    ...
    echo ""
    read -p "which table do you want to delete record(s) from: " table
    echo ""
...
while true
do
    read -p "which column do you want to select from to delete records: " columnSelected
...
echo "$Result" > ./$currentDatabase/$table/"$table"
